...
struct InsightsView: View {
    ...
    fileprivate func createExportImage() -> Image {
        let renderer = ImageRenderer(content:
            VStack(spacing: 16) {
                Text(String(localized: "SpoonPace Weekly Insight"))
                    .font(.title)
                    .bold()
                    .foregroundColor(theme.primary)
                ...
                Text(String(localized: "Generated by SpoonPace • Energy management for Long COVID"))
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
            .padding()
    ...
    fileprivate func exportPDF() -> URL? {
        ...
        let data = pdfRenderer.pdfData { context in
            ...
            // Title
            let title = NSLocalizedString("SpoonPace Weekly Insight", comment: "") as NSString
        ...
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("SpoonPace-Weekly-Insight.pdf")
        do {
    ...
    fileprivate func exportCSV() -> URL? {
        ...
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("SpoonPace-Weekly-Data.csv")
        do {
