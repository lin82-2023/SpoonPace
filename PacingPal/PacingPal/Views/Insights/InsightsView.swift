...
struct InsightsView: View {
    ...
    fileprivate func createExportImage() -> Image {
        let renderer = ImageRenderer(content:
            VStack(spacing: 16) {
                Text(String(localized: "PacingPal Weekly Insight"))
                    .font(.title)
                    .bold()
                    .foregroundColor(theme.primary)
                ...
                Text(String(localized: "Generated by PacingPal • Energy management for Long COVID"))
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
            .padding()
    ...
    fileprivate func exportPDF() -> URL? {
        ...
        let data = pdfRenderer.pdfData { context in
            ...
            // Title
            let title = NSLocalizedString("PacingPal Weekly Insight", comment: "") as NSString
        ...
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("PacingPal-Weekly-Insight.pdf")
        do {
    ...
    fileprivate func exportCSV() -> URL? {
        ...
        let url = FileManager.default.temporaryDirectory.appendingPathComponent("PacingPal-Weekly-Data.csv")
        do {
